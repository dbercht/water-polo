...
function albums(j){  //returns all photos in a specific album
 ...
 $("<div><a target=PICASA class='standard' href='"+album_link+"'>View this album in Picasa</a></div><br>");
 $("<table border=0><tr>");
...
$("<div style='margin-left:3px'><a class='standard' href='/pictures'>Gallery Home</a> &gt; <!--" + img_filename + "-->" + current_index_text + "</div><div style='text-align:right; margin-right:3px; margin-top:-14px'><a target=PICASA class='standard' href='"+photo_link+"'>View this image in Picasa</a></div><br>");
...
if (n1 == null) //we're at the last picture in the album; going forward takes us to the album index
 ...
 $("<td> <a href='"+album_base_path+"'><img border=0 alt='Back to album index' src='home.jpg'></a> </td>");
 if (photo_array.length > 1) { $("<td></td><td> <a href='"+next+"'><img border=0 alt='Next item' src='next.jpg'></a></td>"); }
 $("</tr></table></center><br>");
